...
Route::get('/edit/projects',[ProjectsController::class,"edit"])->name("projects.edit");
Route::post('/delete/projects',[ProjectsController::class,"delete"])->name("projects.delete");
