    ...
    <div class="content-body">
        ...
        <div class="modal fade" id="modals-create">
            <div class="modal-dialog">
                <form class="create-new-projects modal-content pt-0"
                    ...
                    <div class="modal-body flex-grow-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('question') }}" name="title" id="title" required>
                        </div>
                        <div class="form-group">
                            <label for="question">{{ __('title_en') }}</label>
                            <input type="text" class="form-control" value="{{ old('question') }}" name="title_en" id="title_en" required>
                        </div>
                        <div class="form-group">
                            <label for="question">{{ __('service_id') }}</label>
                            <input type="text" class="form-control" value="{{ old('question') }}" name="service_id" id="service_id" required>
                        </div>
                        <div class="form-group">
                            <label for="image">{{ __('main_image') }}</label>
                            <input type="file" class="form-control" value="{{ old('image') }}" name="main_image" id="main_image" required>
                        </div>
                        <div class="form-group">
                            <label for="question">{{ __('daraing_date') }}</label>
                            <input type="text" class="form-control" value="{{ old('question') }}" name="daraing_date" id="daraing_date" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">{{ __(' description_en') }}</label>
...
@section('js')
    ...
    <script>
        ...
        let project_table = $('.projects-list-table').DataTable({
            dom:
            ...
            columns: [
                ...
                {data: 'name_en', name:'title_en',searchable: true},
                {data: 'service_id', name:'service_id',searchable: false},
                {data: 'daraing_date', name:'daraing_date',searchable: false},
    ...
    <script>
        ...
        $("#btn-save").click(function (e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "title_en":jQuery('#title_en').val() ,
                    "service_id":jQuery('#service_id').val() ,
                    "main_image":jQuery('#main_image').val() ,
                    "daraing_date":jQuery('#daraing_date').val() ,
                ...
                success: function (data) {
                    if(data.errors){
                        ...
                        jQuery('#id').val('')
                        $("#create-new-projects").trigger("reset");
                    }
        ...
        function edit(id) {
            ...
            var type = "GET";
            var ajaxurl = "{{route("projects.edit")}}";
        ...
        function deleteConfirmation(id) {
            swal.fire({
                ...
                if (e.value === true) {
                    ...
                    let _url = `{{route('projects.delete')}}`;
